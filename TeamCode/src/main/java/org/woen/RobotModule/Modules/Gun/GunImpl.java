...
import static org.woen.RobotModule.Modules.Camera.Util.MOTIF.GPP;
import static org.woen.RobotModule.Modules.Camera.Util.MOTIF.PGP;
import static org.woen.RobotModule.Modules.Camera.Util.MOTIF.PPG;
...
public class GunImpl implements Gun {
    ...
    private void newVoltageOnEvent(NewVoltageAvailable e) {this.voltage = e.getData();}
