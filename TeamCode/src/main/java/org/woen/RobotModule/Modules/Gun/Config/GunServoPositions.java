...
public class GunServoPositions {
    ...
    public static double eatR = 0.5;
    public static double shotR = 0.65;

    public static double eatC = 0.7;
    public static double shotC = 0.825;

    public static double eatL = 0.49;
    public static double shotL = 0.64;
    ...
    public static double aimCHi = 0.76;
    public static double aimCLow = 0;

    public static double aimLHi = 0.76;
