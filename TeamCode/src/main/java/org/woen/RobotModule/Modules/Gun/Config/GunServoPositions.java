...
public class GunServoPositions {
    ...
    public static double eatRPos = 0.485;
    ...
    public static double aimCFar = 0.8;
    public static double aimCNear = 0.6;

    public static double aimLFar = 0.1;
    public static double aimLNear = 0.1;

    public static double ptoROpen = 0.3;
    public static double ptoLOpen = 0.7;

    public static double ptoRClose = 0.5;
    public static double ptoLClose = 0.5;
}
