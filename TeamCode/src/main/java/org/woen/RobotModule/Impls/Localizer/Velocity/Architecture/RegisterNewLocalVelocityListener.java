...
public class RegisterNewLocalVelocityListener implements
        IEvent<IListener<AbstractVector2d<DoubleCoordinate, Vector2d>>> {

    private final IListener<AbstractVector2d<DoubleCoordinate, Vector2d>> data;

    public RegisterNewLocalVelocityListener(IListener<AbstractVector2d<DoubleCoordinate, Vector2d>> data) {
        this.data = data;
    }
